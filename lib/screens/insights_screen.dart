          ...
          child: Column(
            ...
            children: [
              ...
              _buildStatsTable('Distance breakdown statistics', [
                ...
                ['0 - 20 km', 
                  runs.where((r) => r.distanceKm < 20).length, 
                  '${runs.where((r) => r.distanceKm < 20).fold(0.0, (sum, r) => sum + r.distanceKm).toStringAsFixed(0)} km', 
                  '${runs.where((r) => r.distanceKm < 20).fold(0.0, (sum, r) => sum + r.elevationGain).toStringAsFixed(0)} m', 
                  '${runs.where((r) => r.distanceKm < 20).isNotEmpty ? (runs.where((r) => r.distanceKm < 20).fold(0.0, (sum, r) => sum + r.avgSpeed) / runs.where((r) => r.distanceKm < 20).length * 3.6).toStringAsFixed(2) : '-'} km/h', 
                  '${runs.where((r) => r.distanceKm < 20 && r.avgSpeed > 0).isNotEmpty ? _formatDuration((1000 / (runs.where((r) => r.distanceKm < 20 && r.avgSpeed > 0).fold(0.0, (sum, r) => sum + r.avgSpeed) / runs.where((r) => r.distanceKm < 20 && r.avgSpeed > 0).length)).round()) : '-'} /km', 
                  '${_formatDuration(runs.where((r) => r.distanceKm < 20).fold(0, (sum, r) => sum + r.movingTime))}', 
                  '${_formatDuration(runs.where((r) => r.distanceKm < 20).fold(0, (sum, r) => sum + r.elapsedTime))}'],
                ['20 - 40 km', 
                  runs.where((r) => r.distanceKm >= 20 && r.distanceKm < 40).length, 
                  '${runs.where((r) => r.distanceKm >= 20 && r.distanceKm < 40).fold(0.0, (sum, r) => sum + r.distanceKm).toStringAsFixed(0)} km', 
                  '${runs.where((r) => r.distanceKm >= 20 && r.distanceKm < 40).fold(0.0, (sum, r) => sum + r.elevationGain).toStringAsFixed(0)} m', 
                  '${runs.where((r) => r.distanceKm >= 20 && r.distanceKm < 40).isNotEmpty ? (runs.where((r) => r.distanceKm >= 20 && r.distanceKm < 40).fold(0.0, (sum, r) => sum + r.avgSpeed) / runs.where((r) => r.distanceKm >= 20 && r.distanceKm < 40).length * 3.6).toStringAsFixed(2) : '-'} km/h', 
                  '${runs.where((r) => r.distanceKm >= 20 && r.distanceKm < 40 && r.avgSpeed > 0).isNotEmpty ? _formatDuration((1000 / (runs.where((r) => r.distanceKm >= 20 && r.distanceKm < 40 && r.avgSpeed > 0).fold(0.0, (sum, r) => sum + r.avgSpeed) / runs.where((r) => r.distanceKm >= 20 && r.distanceKm < 40 && r.avgSpeed > 0).length)).round()) : '-'} /km', 
                  '${_formatDuration(runs.where((r) => r.distanceKm >= 20 && r.distanceKm < 40).fold(0, (sum, r) => sum + r.movingTime))}', 
                  '${_formatDuration(runs.where((r) => r.distanceKm >= 20 && r.distanceKm < 40).fold(0, (sum, r) => sum + r.elapsedTime))}'],
                ['40 - 60 km', 
                  runs.where((r) => r.distanceKm >= 40 && r.distanceKm < 60).length, 
                  '${runs.where((r) => r.distanceKm >= 40 && r.distanceKm < 60).fold(0.0, (sum, r) => sum + r.distanceKm).toStringAsFixed(0)} km', 
                  '${runs.where((r) => r.distanceKm >= 40 && r.distanceKm < 60).fold(0.0, (sum, r) => sum + r.elevationGain).toStringAsFixed(0)} m', 
                  '${runs.where((r) => r.distanceKm >= 40 && r.distanceKm < 60).isNotEmpty ? (runs.where((r) => r.distanceKm >= 40 && r.distanceKm < 60).fold(0.0, (sum, r) => sum + r.avgSpeed) / runs.where((r) => r.distanceKm >= 40 && r.distanceKm < 60).length * 3.6).toStringAsFixed(2) : '-'} km/h', 
                  '${runs.where((r) => r.distanceKm >= 40 && r.distanceKm < 60 && r.avgSpeed > 0).isNotEmpty ? _formatDuration((1000 / (runs.where((r) => r.distanceKm >= 40 && r.distanceKm < 60 && r.avgSpeed > 0).fold(0.0, (sum, r) => sum + r.avgSpeed) / runs.where((r) => r.distanceKm >= 40 && r.distanceKm < 60 && r.avgSpeed > 0).length)).round()) : '-'} /km', 
                  '${_formatDuration(runs.where((r) => r.distanceKm >= 40 && r.distanceKm < 60).fold(0, (sum, r) => sum + r.movingTime))}', 
                  '${_formatDuration(runs.where((r) => r.distanceKm >= 40 && r.distanceKm < 60).fold(0, (sum, r) => sum + r.elapsedTime))}'],
              ]),
              const SizedBox(height: 32),
