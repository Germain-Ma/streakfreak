...
class StreakScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Use the new helper for the longest streak runs
    final streakRuns = runProvider.longestStreakRuns;
    final fromDate = streakRuns.isNotEmpty ? streakRuns.first.date : null;
    final toDate = streakRuns.isNotEmpty ? streakRuns.last.date : null;
    final totalKm = streakRuns.fold(0.0, (sum, run) => sum + run.distanceKm);
    final avgKmPerDay = longestStreak > 0 ? totalKm / longestStreak : 0.0;
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildStreakTable([
                    ['Days', longestStreak],
                    ['From', fromDate != null ? DateFormat.yMMMd().format(fromDate) : '-'],
                    ['To', toDate != null ? DateFormat.yMMMd().format(toDate) : '-'],
